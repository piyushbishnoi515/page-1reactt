      ...
      <div className="container mt-[135px]">
        ...
        <div className="flex gap-[24px] justify-center mt-[40px] mb-[106px]">
          {CARD_DATA.map((i, index) => (
            <div key={index} className={`${index === 0 ? 'bg-green-400 ' : index === 1 ? 'bg-green-700' : index === 2 ? 'bg-gray-600' : null
              } pinkbox p-[20px_30px_20px_30px] border-[2px] border-[#FFFFFF] rounded-[22px] max-w-[365px] max-h-[276px] group/men duration-300 transition-all ease-linear`}>
              {i.icon}
